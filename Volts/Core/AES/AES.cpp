...
namespace Volts
{
    ...
    bool SupportsSSE2 = !!(SupportedInstructions() & Instruction::SSE2);
    bool SupportsAES = !!(SupportedInstructions() & Instruction::AES);

static const unsigned char ForwardBox[] =
{
...
static const U32 FT0[] = { FT };
#undef V

#define V(a,b,c,d) 0x##b##c##d##a
static const U32 FT1[] = { FT };
#undef V

#define V(a,b,c,d) 0x##c##d##a##b
static const U32 FT2[] = { FT };
#undef V

#define V(a,b,c,d) 0x##d##a##b##c
static const U32 FT3[] = { FT };
#undef V
 ...
 * Reverse S-box
 */
static const unsigned char ReverseBox[] =
{
...
#define V(a,b,c,d) 0x##a##b##c##d
static const U32 RT0[] = { RT };
#undef V

#define V(a,b,c,d) 0x##b##c##d##a
static const U32 RT1[] = { RT };
#undef V

#define V(a,b,c,d) 0x##c##d##a##b
static const U32 RT2[] = { RT };
#undef V

#define V(a,b,c,d) 0x##d##a##b##c
static const U32 RT3[] = { RT };
#undef V
...
#   define GET_UINT(B, I) (((U32)(B)[I]) | ((U32)(B)[(I) + 1] << 8) | ((U32)(B)[(I) + 2] << 16) | ((U32)(B)[(I) + 3] << 24))
    ...
    void AES::SetKeyEnc(const Cthulhu::Byte* Key, KeySize Size)
    {
        ...
        case KeySize::S128: 
            ...
            {
                RK[4] = RK[0] ^ RCON[I] ^
                    ((U32)ForwardBox[(RK[3] >> 8) & 0xFF]) ^
                    ((U32)ForwardBox[(RK[3] >> 16) & 0xFF] << 8) ^
                    ((U32)ForwardBox[(RK[3] >> 24) & 0xFF] << 16) ^
                    ((U32)ForwardBox[(RK[3]) & 0xFF] << 24);
        ...
        case KeySize::S256:
            ...
            for(U32 I = 0; I < 7; I++, RK += 8)
            {
                ...
                RK[12] = RK[4] ^ 
                    ...
                    ((U32)ForwardBox[(RK[11] >> 24) & 0xFF] << 24);
    ...
    void AES::SetKeyDec(const Cthulhu::Byte* Key, KeySize Size)
    {
        ...
        *RK++ = *SK++;
        ...
        U32 I = 0;
        for(I = Rounds - 1, SK -= 8; I > 0; I--, SK -= 8)
        {
            for(U32 J = 0; J < 4; J++, SK++)
            {
                *RK++ = RT0[ForwardBox[(*SK) & 0xFF]] ^
                        RT1[ForwardBox[(*SK >> 8) & 0xFF]] ^
                        RT2[ForwardBox[(*SK >> 16) & 0xFF]] ^
                        RT3[ForwardBox[(*SK >> 24) & 0xFF]];
            }
        }
